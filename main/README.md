...
For a video file "ApplyMakeUp.avi":

```
Input: ApplyMakeUp.avi (5 frames)
Output: "a woman applying makeup to her face a woman putting on lipstick a woman looking in a mirror a woman with makeup on her face a woman smiling at the camera"
```
